...
import { FaArrowRight, FaNewspaper, FaStore } from 'react-icons/fa';

const Eksplorasi = () => {
  return (
    <section className="eksplorasi flex items-center mt-24 px-4 sm:px-32 py-24 bg-gradient-to-tr from-blue-500 to-blue-700">
